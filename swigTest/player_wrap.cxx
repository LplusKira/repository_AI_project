...
SWIGINTERN PyObject *_wrap_fifo_test(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:fifo_test",&obj0)) SWIG_fail;
  {
    ...
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "fifo_test" "', argument " "1"" of type '" "std::vector< int,std::allocator< int > >""'"); 
    }
    arg1 = *ptr;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"fifo_test", _wrap_fifo_test, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
